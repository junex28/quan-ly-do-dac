...
dojo.provide("com.esri.solutions.jsviewer.WidgetFrame");
...
dojo.requireLocalization("com.esri.solutions.jsviewer", "WidgetFrameStrings");

dojo.require("dojo.fx");

dojo.declare(
	"com.esri.solutions.jsviewer.WidgetFrame",
	[dijit._Widget, dijit._Templated, dijit._Container, dijit._Contained],
	{
		...
		templatePath: dojo.moduleUrl("com.esri.solutions.jsviewer", "templates/WidgetFrame.html"),
		...
		postMixInProperties: function() {
			...
			// Init i18n
			this.i18nStrings = dojo.i18n.getLocalization("com.esri.solutions.jsviewer", "WidgetFrameStrings");
		...
		setIcon: function(/* String */ icon) {
			try {
				...
				dojo.style(this.badgeNode, "backgroundImage",
					"url(" + dojo.moduleUrl("com.esri.solutions.jsviewer", icon) + ")");
			}
			catch (err) { console.error(err); }
		},
				...
				if (widget.panels.length > 1) {
					dojo.forEach(widget.panels, dojo.hitch(this, function(item, idx, arr){
						...
						dojo.style(btn, "backgroundImage",
							"url(" + dojo.moduleUrl("com.esri.solutions.jsviewer", item.buttonIcon) + ")");
