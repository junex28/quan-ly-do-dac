...
dojo.provide("com.esri.solutions.jsviewer.widgets.EditWidget");
...
dojo.declare("com.esri.solutions.jsviewer.widgets.EditWidget", [com.esri.solutions.jsviewer._BaseWidget, com.esri.solutions.jsviewer._MapGraphicsMaintainer], {
    ...
    postMixInProperties: function(){
        ...
        try {
            ...
            if (this.configData) {
                //json configuration
                var c = this.configData.editlayer;
    ...
    queryRecordsByPage: function(pageNumber){
        try {
            ...
            this.featureLayer = new esri.layers.FeatureLayer(this.layerUrl, {
                outFields: this.queryFields,
                mode: esri.layers.FeatureLayer.MODE_SELECTION
            });
    ...
    updateGrid: function(features, pageNumber){
        try {
            ...
            if (features) {
                ...
                var locations = [];
                var ce = this.configData.editlayer.layerInfo;
