...
dojo.declare("com.esri.solutions.jsviewer.ResultItem",
	[dijit._Widget, dijit._Templated],
	{
		...
		postCreate: function() {
			...
			this.setShortContent(this.shortcontent);
		},
		
		setShortContent: function(/*String*/ shortcontent){
			if (this.suppressImages) {
				shortcontent = shortcontent.replace(/<img [^>]*>/ig,"<!--img removed-->");
			}
			this.shortcontent = shortcontent;
			this.contentNode.innerHTML = shortcontent;
