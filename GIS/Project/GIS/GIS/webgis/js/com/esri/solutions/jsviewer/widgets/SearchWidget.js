	                ...
	                try {
	                    ...
	                    switch (geometry.type) {
	                        ...
	                        case "polyline":
	                            ...
	                            break;
	                        case "polygon":
	                            var symbol = new esri.symbol.SimpleFillSymbol(esri.symbol.SimpleFillSymbol.STYLE_NONE, new esri.symbol.SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_DASHDOT, new dojo.Color([255, 255, 0]), 2), new dojo.Color([255, 255, 0, 0.25]));
	                            break;
	                        case "extent":
