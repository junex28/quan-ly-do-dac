...
/*These files are now loaded from index.html
(function() {
var css = [
...
if (dojo.isIE) {
  (function() {
    var js = [
      dojo.moduleUrl("dijits.identify", "libraries/DD_roundies_0.0.2a.js")
    ];
...
dojo.declare("dijits.identify.Identify", [dijit._Widget, dijit._Templated], {
    ...
    *************/
    ...
    startup: function() {
		...
		//dojo.parser.parse(this.domNode);
         /*
        if (dojo.isIE) {
        DD_roundies.addRule('.genid-rounded-corner', '10', true);
        }
                   */
    ...
    */
    ...
    destroy: function() {
        this._disconnectHandlers();
        this._clearGraphics();
        if (this._iwconnector)
            this._iwconnector.destroy();

        this._makeNull(this._locationGraphic);
        this._makeNull(this._selectedFeature);
        this._makeNull(this._stackContainer);
        this._makeNull(this._backButtonRegion);
        this._makeNull(this._featureGrid);
        this._makeNull(this._infoGrid);
        this._makeNull(this._optTolerance);
        this._makeNull(this._focusSpan);
        this._makeNull(this._iwconnector);
    ...
    *******************/
    ...
    _showFeatures: function(idResults, mapPoint, options) {
        ...
        //window.setTimeout(Function.createDelegate(this, function(){this._stackContainer.selectChild(this._stackContainer.getChildren()[0]);}), 0);
    ...
    _gridRowClickHandler: function(evt) {
      ...
      { data: { identifier: "UNIQ_ID", label: "UNIQ_ID", items: items} }
        ...
        //////////////////////////////3333333333333333333333333333333#######################################################
        var theNode = this._infoGrid.domNode;
        var anim1 = dojo.fx.slideTo({ node: theNode, left: 100, top: 0, unit: "px", duration: 1 });
        var anim2 = dojo.fx.slideTo({ node: theNode, left: 5, top: 0, unit: "px", duration: 300, easing: dojo.fx.easing.expoIn });
        var anim3 = dojo.fx.slideTo({ node: theNode, left: 20, top: 0, unit: "px", duration: 200 });
        var anim4 = dojo.fx.slideTo({ node: theNode, left: 0, top: 0, unit: "px", duration: 200 });
        var anim5 = dojo.fx.slideTo({ node: theNode, left: 5, top: 0, unit: "px", duration: 100 });
        var anim6 = dojo.fx.slideTo({ node: theNode, left: 0, top: 0, unit: "px", duration: 100 });

        dojo.fx.chain([anim1,anim2, anim3, anim4, anim5, anim6]).play();
        this._doIEAnimationFix(theNode);
        //////////////////////////////3333333333333333333333333333333#######################################################
    },
    ...
    _backButtonClickHandler: function() {
        ...
        //////////////////////////////3333333333333333333333333333333#######################################################
        var theNode = this._featureGrid.domNode;
        this._doIEAnimationFix(theNode);
        var anim1 = dojo.fx.slideTo({ node: theNode, left: -170, top: 0, unit: "px", duration: 1 });
        var anim2 = dojo.fx.slideTo({ node: theNode, left: 0, top: 0, unit: "px", duration: 300, easing: dojo.fx.easing.expoIn });
        var anim3 = dojo.fx.slideTo({ node: theNode, left: 30, top: 0, unit: "px", duration: 200 });
        var anim4 = dojo.fx.slideTo({ node: theNode, left: 0, top: 0, unit: "px", duration: 200 });
        var anim5 = dojo.fx.slideTo({ node: theNode, left: 5, top: 0, unit: "px", duration: 100 });
        var anim6 = dojo.fx.slideTo({ node: theNode, left: 0, top: 0, unit: "px", duration: 100 });
    ...
    _showOptionsPage: function() {
        ...
        //////////////////////////////3333333333333333333333333333333#######################################################       
        var theNode = this._optionsGrid.domNode;
        this._doIEAnimationFix(theNode);
        var anim1 = dojo.fx.slideTo({ node: theNode, left: 0, top: 200, unit: "px", duration: 1 });
        var anim2 = dojo.fx.slideTo({ node: theNode, left: 0, top: 0, unit: "px", duration: 350, easing: dojo.fx.easing.expoIn });
        var anim3 = dojo.fx.slideTo({ node: theNode, left: 0, top: 30, unit: "px", duration: 200 });
        var anim4 = dojo.fx.slideTo({ node: theNode, left: 0, top: 0, unit: "px", duration: 200 });
        var anim5 = dojo.fx.slideTo({ node: theNode, left: 0, top: 5, unit: "px", duration: 100 });
        var anim6 = dojo.fx.slideTo({ node: theNode, left: 0, top: 0, unit: "px", duration: 100 });
        dojo.fx.chain([anim1, anim2, anim3, anim4, anim5, anim6]).play();
        //////////////////////////////3333333333333333333333333333333#######################################################
    },
    ...
    //////////////////////////////3333333333333333333333333333333#######################################################   
    _doIEAnimationFix: function(pane) {
        //[GOTCHA-dh] another IE mystery. for the animated behavior, IE adds scrollbars to the
        //contentPane div.
        //debugger;
        if (dojo.isIE) {
            dojo.style(pane.parentElement, "overflow", "hidden");
            dojo.style(pane, "overflow", "hidden");
        }
    }
    //////////////////////////////3333333333333333333333333333333#######################################################
