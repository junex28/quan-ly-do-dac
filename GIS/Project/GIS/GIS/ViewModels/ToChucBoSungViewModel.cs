...
{
    public class ToChucBoSungViewModel
    {
        ...
        [Required(ErrorMessage = "Số giấy phép đo đạc không được trống")]
        [DisplayName("Giấy phép đo đạc")]
        public string GiayPhepDoDac { get; set; }

        [DisplayName("Ngày cấp phép đo đạc")]
        public DateTime NgayCapPhepDoDac { get; set; }
        ...
        public IList<CongTrinhVM> CongTrinhs { get; set; }
    ...
    public class CongTrinhVM{
        ...
        public string CongDoanDaThiCong { get; set; }
